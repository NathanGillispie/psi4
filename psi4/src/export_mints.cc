...
void export_mints(py::module& m) {
    ...
    py::class_<SFamfX2C>(m, "amfx2c", "Initializes and defines amfX2C-SF object")
        ...
        .def_property_readonly_static("bs_radii", [](py::object /* self */){ return std::vector<double>{
      0.661,                                                                                                                0.661, // He
      ...
      4.913, 4.063, 3.685, 3.496, 3.496, 3.496, 3.496, 3.496, 3.496, 3.402, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307,//*La-Lu
      2.929, 2.740, 2.551, 2.551, 2.457, 2.551, 2.551, 2.551, 2.835, 3.591, 3.024, 3.024, 3.591, 3.591, 3.591, // Rn
      4.063, 4.063, 3.685, 3.401, 3.401, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307, 3.307,//Ac-Lr
    }; } );
